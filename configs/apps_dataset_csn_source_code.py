...
"""修改"""
tokenizer = GPT2TokenizerFast.from_pretrained('/root/My/models/gpt2-tokenizer')
model = GPT2ForSequenceClassification.from_pretrained('/root/My/models/py150-TCQE/checkpoint-last')
...
class APPSBaseDataset(torch.utils.data.Dataset):
    def __init__(self, dataroot, problem_dirs, model, max_tokens, sample_mode,
        ...
        self.initialize()
        """修改"""
        self.tokenizer = GPT2TokenizerFast.from_pretrained('/root/My/models/py150-TCQE/checkpoint-last')
    ...
    def initialize(self):
        ...
        for problem_name in tqdm(self.problem_dirs):
            ...
            with open(all_question_fname,'r') as file:
                ...
                all_question_str = all_question_str[:all_question_str.__len__()-9]
                all_question_str = all_question_str + tokenizer.eos_token
